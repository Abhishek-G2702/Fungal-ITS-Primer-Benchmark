...
# Constants
TOTAL_ALL_SPECIES = 18605
TOTAL_PATHOGENIC_SPECIES = 559

# Output folder to save plots and explanation
output_folder = "18may_code2_baaaarplot-1"
...
def plot_bar(df_percent, title, output_name):
    ...
    """
    plt.figure(figsize=(12, 6))  # Medium size graph (12x6 inches)
    bars = plt.bar(df_percent["Primer Pair"], df_percent["Percentage"], 
                  color="red", width=0.5)  # Optimal bar width for medium size
    ...
    plt.yticks([0, 10, 20, 30, 40, 50])  # Custom y-axis ticks
...
# File paths
all_file = "/home/abhishek/ITS/NCBI/code1_result_primer_search_results/primer_pair_results_all.xlsx"
pathogens_file = "/home/abhishek/ITS/NCBI/code1_result_primer_search_results/primer_pair_results_pathogens.xlsx"
